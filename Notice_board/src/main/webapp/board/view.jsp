			...
			<div class="form-group row mb-3">
				<div class="col-sm-offset-2 col-sm-12 ">
					...
					<c:if test="${sessionId==userId}">
						<p>
							<a	href="./BoardDeleteAction.do?num=<%=notice.getNum()%>&pageNum=<%=nowpage%>"	class="btn btn-outline-danger">삭제</a> 
							<input type="submit" class="btn btn-outline-success" value="수정">
					</c:if>
					<a href="./BoardListAction.do?pageNum=<%=nowpage%>" class="btn btn-outline-info">목록</a>
				</div>
			</div>
		</form>
