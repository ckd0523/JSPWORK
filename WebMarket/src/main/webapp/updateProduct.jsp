			...
			<div class="col-md-7">
				<form name="newProduct" action="./processUpdateProduct.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
					...
					<label class="col-sm-2">재고 수</label>
						<div class="col-sm-3">
							<input type="text" id="unitInStock" name="unitInStock" class="form-control" value='<%=rs.getString("p_unitInStock")%>'>
						</div>
					</div>
					<div class="form-group-row">
					<label class="col-sm-2">상태</label>
						<div class="col-sm-5">
							<input type="radio" id="condition" value="New">
							신규 제품
							<input type="radio" id="condition" value="Old">
							중고 제품
							<input type="radio" id="condition" value="Refurbished">
							재생 제품
						</div>
					</div>
					<div class="form-group-row">
